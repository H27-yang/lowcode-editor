<template>
    <div
      ...
      :style="{
        ...
        lineHeight: String(component.style.lineHeight || 1.5),
  ...
  import type { ComponentData, TextProps } from '@/type'
  
  const props = defineProps<{
    component: ComponentData
  }>()
  
  const textProps = computed(() => props.component.props as TextProps)
  </script>
